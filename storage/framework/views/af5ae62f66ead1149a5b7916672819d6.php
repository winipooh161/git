...
<div class="certificate-iframe-editor">
    <div class="editor-header">
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between py-2">
                <h1 class="h5 fw-bold mb-0">Редактирование документа #<?php echo e($certificate->certificate_number); ?></h1>
                <div>
                    <button id="updateCertificateBtn" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-save me-1"></i> Сохранить изменения
                    </button>
                    <a href="<?php echo e(route('entrepreneur.certificates.show', $certificate)); ?>" class="btn btn-outline-secondary btn-sm ms-2">
    ...
    <div class="editor-body vh-100">
        <div class="certificate-iframe-container">
            ...
            <iframe id="certificateEditorIframe" src="<?php echo e(route('template.preview', ['template' => $template, 'editable' => true, 'certificate' => $certificate])); ?>" class="certificate-editor-iframe"></iframe>
            
            <!-- Форма для отправки данных, заполняется из iframe -->
            <form id="certificateDataForm" action="<?php echo e(route('entrepreneur.certificates.update', $certificate)); ?>" method="POST" enctype="multipart/form-data" style="display:none;">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <!-- Эти поля будут заполняться динамически из iframe -->
                <input type="hidden" name="recipient_name" id="recipient_name_hidden" value="<?php echo e(old('recipient_name', $certificate->recipient_name)); ?>">
                <input type="hidden" name="recipient_phone" id="recipient_phone_hidden" value="<?php echo e(old('recipient_phone', $certificate->recipient_phone)); ?>">
                <input type="hidden" name="recipient_email" id="recipient_email_hidden" value="<?php echo e(old('recipient_email', $certificate->recipient_email)); ?>">
                <input type="hidden" name="amount" id="amount_hidden" value="<?php echo e(old('amount', $certificate->is_percent ? 0 : $certificate->amount)); ?>">
                <input type="hidden" name="percent_value" id="percent_value_hidden" value="<?php echo e(old('percent_value', $certificate->is_percent ? $certificate->amount : 0)); ?>">
                <input type="hidden" name="amount_type" id="amount_type_hidden" value="<?php echo e($certificate->is_percent ? 'percent' : 'money'); ?>">
                <input type="hidden" name="message" id="message_hidden" value="<?php echo e(old('message', $certificate->message)); ?>">
                <input type="hidden" name="company_name" id="company_name_hidden" value="<?php echo e($certificate->company_name); ?>">
                <input type="hidden" name="valid_from" id="valid_from_hidden" value="<?php echo e(old('valid_from', $certificate->valid_from->format('Y-m-d'))); ?>">
                <input type="hidden" name="valid_until" id="valid_until_hidden" value="<?php echo e(old('valid_until', $certificate->valid_until->format('Y-m-d'))); ?>">
                <input type="hidden" name="temp_cover_path" id="temp_cover_path_hidden" value="">
                <input type="hidden" name="status" id="status_hidden" value="<?php echo e(old('status', $certificate->status)); ?>">
                ...
                <?php if(is_array($template->fields) && count($template->fields) > 0): ?>
                    <?php $__currentLoopData = $template->fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="custom_fields[<?php echo e($key); ?>]" id="custom_<?php echo e($key); ?>_hidden" 
            ...
            <form method="POST" action="<?php echo e(route('entrepreneur.certificates.destroy', $certificate)); ?>" id="cancelForm" style="display:none;">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="recipient_name" placeholder="Введите имя получателя" value="<?php echo e(old('recipient_name', $certificate->recipient_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control bg-light <?php $__errorArgs = ['recipient_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    id="recipient_phone" value="<?php echo e(old('recipient_phone', $certificate->recipient_phone)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control <?php $__errorArgs = ['recipient_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    id="recipient_email" value="<?php echo e(old('recipient_email', $certificate->recipient_email)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="d-flex">
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="amount_type" id="amount_type_money" 
                                            value="money" <?php echo e(!$certificate->is_percent ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="amount_type" id="amount_type_percent" 
                                            value="percent" <?php echo e($certificate->is_percent ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div id="money_amount_block" class="<?php echo e($certificate->is_percent ? 'd-none' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                        id="amount" value="<?php echo e(old('amount', $certificate->is_percent ? 0 : $certificate->amount)); ?>" min="0" step="100">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="percent_amount_block" class="<?php echo e(!$certificate->is_percent ? 'd-none' : ''); ?>">
                                    <label for="percent_value" class="form-label">Процент скидки *</label>
                                    <div class="input-group">
                                        <input type="number" class="form-control <?php $__errorArgs = ['percent_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            id="percent_value" value="<?php echo e(old('percent_value', $certificate->is_percent ? $certificate->amount : 0)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="company_name" value="<?php echo e(old('company_name', $certificate->company_name)); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="valid_from" value="<?php echo e(old('valid_from', $certificate->valid_from->format('Y-m-d'))); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="valid_until" value="<?php echo e(old('valid_until', $certificate->valid_until->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                    id="message" rows="3"><?php echo e(old('message', $certificate->message)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="d-grid">
                            <a href="<?php echo e(route('photo.editor', ['template' => $template->id, 'certificate' => $certificate->id])); ?>" class="btn btn-outline-primary">
                                <i class="fa-solid fa-image me-2"></i><?php echo e($certificate->cover_image ? 'Изменить обложку' : 'Создать обложку'); ?>
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="row g-3">
                            <?php $__currentLoopData = $template->fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6">
                                    <label for="custom_<?php echo e($key); ?>" class="form-label">
                                        <?php echo e($field['label'] ?? $key); ?> 
                                        <?php if(isset($field['required']) && $field['required']): ?>
                                            <span class="text-danger">*</span>
                                        <?php endif; ?>
                                    </label>
                                    <input type="text" class="form-control <?php $__errorArgs = ['custom_fields.'.$key];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
