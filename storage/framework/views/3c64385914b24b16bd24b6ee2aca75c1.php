...
<head>
    ...
    <?php if(app()->environment('production')): ?>
        ...
        ?>
        <script src="<?php echo e(asset('build/' . $manifest['resources/js/app.js']['file'])); ?>" defer></script>
...
<?php /**PATH C:\OSPanel\domains\sert\resources\views/layouts/app.blade.php ENDPATH**/ ?>