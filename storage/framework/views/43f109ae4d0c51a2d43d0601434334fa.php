                        ...
                        <div class="col-md-2 p-4 border-end">
                            ...
                            <div class="mb-3">
                                ...
                                <span class="fw-bold">
                                    ...
                                    ?>
                                    <?php echo e($fromDate); ?> - <?php echo e($untilDate); ?>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-2">
                                <strong>Размер серии:</strong> <?php echo e($certificate->batch_size); ?> экземпляров
                            </p>
                            <p class="mb-2">
                                <strong>Активировано:</strong> <?php echo e($certificate->activation_progress_string); ?>
                            ...
                            <div class="progress mb-4" style="height: 25px;">
                                <div class="progress-bar <?php echo e($certificate->activation_progress_percent < 50 ? 'bg-success' : ($certificate->activation_progress_percent < 90 ? 'bg-warning' : 'bg-danger')); ?>" 
                                     role="progressbar" 
                                     style="width: <?php echo e($certificate->activation_progress_percent); ?>%;" 
                                     aria-valuenow="<?php echo e($certificate->activation_progress_percent); ?>" 
                                     aria-valuemin="0" 
                                     aria-valuemax="100">
                                    <?php echo e($certificate->activation_progress_percent); ?>%
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="alert alert-info mb-0">
                                ...
                                <p class="mb-0">Этот сертификат создан как серия из <?php echo e($certificate->batch_size); ?> экземпляров. Когда клиент активирует сертификат, он получает один экземпляр из серии.</p>
                                ...
                                <?php elseif($certificate->activated_copies_count / $certificate->batch_size >= 0.8): ?>
...
Рад(а) отправить Вам подарочный документ на <?php echo e(number_format($certificate->amount, 0, '.', ' ')); ?> рублей.
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Вы уверены, что хотите отменить документ <strong><?php echo e($certificate->certificate_number); ?></strong>?</p>
            </div>
            <div class="modal-footer">
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $certificate->copies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $copy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($copy->batch_number ?? 'N/A'); ?></td>
                                <td>
                                    <a href="<?php echo e(route('entrepreneur.certificates.show', $copy)); ?>" target="_blank">
                                        <?php echo e($copy->certificate_number); ?>

                                    </a>
                                </td>
                                <td>
                                    <?php if($copy->recipient_name || $copy->recipient_email || $copy->recipient_phone): ?>
                                ...
                                <td>
                                    <?php if($copy->recipient_name || $copy->recipient_email || $copy->recipient_phone): ?>
                                        <?php echo e($copy->updated_at->format('d.m.Y H:i')); ?>

                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($copy->recipient_name ?? 'Не указан'); ?></td>
                            </tr>
