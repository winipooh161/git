<div class="d-flex align-items-center justify-content-between  profile-header-mobile">
    ...
    <div class="position-relative"> <a href="{{ route('profile.index') }}" class="avatar-container avatar-link " title="Перейти в профиль">
        @if(Auth::user()->avatar)
    ...
    </a>  <a href="{{ route('subscription.plans') }}" class="plan-badge position-absolute" title="Ваш тариф: {{ Auth::user()->currentPlan()->name }}">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    ...
                    <div class="me-3 p-2 bg-light rounded d-inline-block">
                        ...
                        <span class="fw-bold">{{ Auth::user()->sticks }}</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadAnalyticsTab(type) {
        ...
        const url = type === 'statistics' ? 
            '{{ route("entrepreneur.analytics.statistics") }}' : 
            '{{ route("entrepreneur.analytics.reports") }}';
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function loadNotifications(replace = true) {
            ...
            let url = new URL('{{ route("notifications.index") }}');
