...
<div class="container-fluid py-4">
    ...
    <div class="alert alert-info mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="mb-0">У вас доступно: <strong>{{ Auth::user()->sticks }}</strong> стиков.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body">
            <form action="{{ route('entrepreneur.certificates.select-template') }}" method="GET" id="filter-form">
                <div class="row g-3">
    ...
    <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card h-100 shadow-sm border-0 rounded-4">
                    <div class="position-relative">
                        <img src="{{ $template->image_url }}" class="card-img-top rounded-top" alt="{{ $template->name }}">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text small text-muted mb-2">
                            <i class="fa-solid fa-folder me-1"></i> {{ $template->category->name ?? 'Без категории' }}
                        </p>
                        ...
                        <div class="mt-auto pt-3">
                            <a href="{{ route('entrepreneur.certificates.create', $template) }}" class="btn btn-primary w-100">
        ...
        @empty
            <div class="col-12 text-center py-5">
                ...
                <p class="mt-3">
                    <a href="{{ route('entrepreneur.certificates.select-template') }}" class="btn btn-outline-primary">
