...
<div class="certificate-iframe-editor">
    ...
    <div class="editor-body vh-100">
        <div class="certificate-iframe-container">
            ...
            <iframe id="certificateEditorIframe" src="{{ route('template.preview', ['template' => $template, 'editable' => true]) }}" class="certificate-editor-iframe"></iframe>
            
            <!-- Форма для отправки данных, заполняется из iframe -->
            <form id="certificateDataForm" action="{{ route('entrepreneur.certificates.store', $template) }}" method="POST" enctype="multipart/form-data" style="display:none;">
                @csrf
                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="d-grid mb-3">
                            <a href="{{ route('photo.editor', ['template' => $template->id]) }}" class="btn btn-outline-primary">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2">
                                        <input type="number" class="form-control" id="batch_size" name="batch_size" 
                                               min="1" max="{{ Auth::user()->sticks }}" value="1" required>
                                ...
                                <div class="col-md-6">
                                    <div class="sticks-info p-3 bg-light rounded">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span class="badge bg-primary fs-6">{{ Auth::user()->sticks }}</span>
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('company_name').value = "{{ Auth::user()->company_name ?? config('app.name') }}";
    ...
    const availableSticks = {{ Auth::user()->sticks }};
