    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex">
            <div class="btn-group me-2" role="group">
                <a href="{{ route('notifications.index') }}" class="btn btn-outline-primary {{ !request()->has('read') ? 'active' : '' }}">Все</a>
                <a href="{{ route('notifications.index', ['read' => '0']) }}" class="btn btn-outline-primary {{ request()->get('read') === '0' ? 'active' : '' }}">Непрочитанные</a>
                <a href="{{ route('notifications.index', ['read' => '1']) }}" class="btn btn-outline-primary {{ request()->get('read') === '1' ? 'active' : '' }}">Прочитанные</a>
            </div>
            
            <form action="{{ route('notifications.mark-all-read') }}" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-outline-secondary" {{ Auth::user()->unreadNotificationsCount() > 0 ? '' : 'disabled' }}>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-0">
            <div class="notifications-list">
                @include('notifications.partials._notifications_list', ['notifications' => $notifications])
            </div>
        </div>
    </div>
